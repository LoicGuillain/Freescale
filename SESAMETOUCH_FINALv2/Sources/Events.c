/* ###################################################################
**     Filename    : Events.c
**     Project     : SESAMETOUCH_FINAL
**     Processor   : MK64FN1M0VLL12
**     Component   : Events
**     Version     : Driver 01.00
**     Compiler    : GNU C Compiler
**     Date/Time   : 2015-09-01, 09:56, # CodeGen: 0
**     Abstract    :
...
/*
** ===================================================================
**     Event       :  SM3_OnRxChar (module Events)
**
**     Component   :  SM3 [SynchroMaster]
**     Description :
**         This event is called after a correct character is received.
**         The event is available only when the <Interrupt
**         service/event> property is enabled.
...
/*
** ===================================================================
**     Event       :  SM3_OnTxChar (module Events)
**
**     Component   :  SM3 [SynchroMaster]
**     Description :
**         This event is called after a character is transmitted.
...
/*
** ===================================================================
**     Event       :  SM3_OnFullRxBuf (module Events)
**
**     Component   :  SM3 [SynchroMaster]
**     Description :
**         This event is called when the input buffer is full, i.e.
...
/*
** ===================================================================
**     Event       :  SM3_OnFreeTxBuf (module Events)
**
**     Component   :  SM3 [SynchroMaster]
**     Description :
**         This event is called after the last character in output
...
/*
** ===================================================================
**     Event       :  SM3_OnError (module Events)
**
**     Component   :  SM3 [SynchroMaster]
**     Description :
**         This event is called when a channel error (not the error
...
/*
** ===================================================================
**     Event       :  NEXT_SPI_OnBlockSent (module Events)
**
**     Component   :  NEXT_SPI [SPIMaster_LDD]
*/
/*!
**     @brief
...
*/
/* ===================================================================*/
void NEXT_SPI_OnBlockSent(LDD_TUserData *UserDataPtr)
{
  /* Write your code here ... */
}
...
/*
** ===================================================================
**     Event       :  NEXT_SPI_OnBlockReceived (module Events)
**
**     Component   :  NEXT_SPI [SPIMaster_LDD]
*/
/*!
...
*/
/* ===================================================================*/
void NEXT_SPI_OnBlockReceived(LDD_TUserData *UserDataPtr)
{
  /* Write your code here ... */
}
